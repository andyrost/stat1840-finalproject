...
```{r}
na.omit(CVX)
ggplot(data = na.omit(CVX)) + geom_line(aes(x = Date, y = Close, color = "CVX Close")) +
  geom_line(aes(x=Date, y = weekma,color = "ThreeWeekAvg")) + geom_line(aes(x=Date, y = tweekma,color = "100DayAvg"))
```
