...
author: "Andrew Rost and Pavel Sachivichik"
...
(A) .Rmd Line numbers where at least two different data sources are imported: 37


(B) .Rmd Line numbers for inspecting data intake: 38
...
(A) .Rmd Line number(s) for general data wrangling: 62, 96

(B) .Rmd Line number(s) for a join operation: 94

(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): N/A

(D) .Rmd Line number(s) for use of regular expressions: N/A

(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 42

(F) .Rmd Line number(s) for use of user-defined functions: 64

(G) .Rmd Line number(s) for use of loops and/or control flow: 66
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 77

(B) .Rmd Line number(s) for use of multiple aesthetics: 77, 159

(C) .Rmd Line number(s) for use of layered graphics: 77
